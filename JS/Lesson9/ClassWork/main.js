...
//
//     div.append(divName, divSurname, divAge, divInfo, divPhoto);
//     document.body.appendChild(div);
// }
...
for (let coursesArrayElement of coursesArray) {
    ...
    let divMouth = document.createElement('div');
    divMouth.innerText = coursesArrayElement.monthDuration;
    let divHour = document.createElement('div');
    divHour.innerText = coursesArrayElement.hourDuration
    let ul = document.createElement('ul');

    for (let module in coursesArrayElement.modules) {
    ...
    div.append(divTitle, divMouth, divHour, ul);
    document.body.appendChild(div);
}